...
namespace ImageGallery.Client.Controllers
{
    ...
    public class GalleryController : Controller
    {
        ...
        private readonly IOptionsMonitor<KeyCloakConfiguration> _keyCloakConfiguration;

        public GalleryController(
            IHttpClientFactory httpClientFactory,
            IOptionsMonitor<KeyCloakConfiguration> keyCloakConfiguration)
        {
        ...
        public async Task Logout()
        {
            ...
            var accessTokenRevocationResponse = await client.RevokeTokenAsync(
                new TokenRevocationRequest
                {
                    ...
                    ClientId = _keyCloakConfiguration.CurrentValue.ClientId,
                    ClientSecret = _keyCloakConfiguration.CurrentValue.ClientSecret,
